...
namespace DVG.CRM.XeCung.WebAPI.Filter
{
    public class AuthorizationAttribute : ActionFilterAttribute
    {
        ...
        public override void OnActionExecuting(ActionExecutingContext filterContext)
        {
            ...
            if (DateTime.Now.Ticks > currentUser.ExpiredRandomKey)
            {
                filterContext.Result = result;
                return;
            }
            ...
            //var validateToken = ChecksumHelper.ValidateToken(new { Id = currentUser.Id, CurrUser = currentUser.UserName, RandomKey = currentUser.RandomKey }, token);
